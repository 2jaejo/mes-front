  ...
  useEffect(()=>{
    ...
    .then((res) => {
      ...
      setColumnDefs2([
        ...
        { headerName: "포장작업지시", field: "pack_order_yn", sortable: false, editable: false, align:"center",
          ...
          valueGetter: (params) => {
            return params.data.pack_order_yn === 'Y';
          },
          
        },
        { headerName: "포장완료수량", field: "result_pack_cnt", sortable: false, editable: false, align:"right"},
