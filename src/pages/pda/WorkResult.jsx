...
const Main = ({ props={}, isActive}) => {
    ...
    .then((res) => {
      ...
      axiosInstance
        ...
        .then((res) => {
          ...
          const currentIdx = modalForm.work_idx; // 또는 form?.work_idx
  ...
  return (
    <div style={{ height: '87vh', display: 'flex', flexDirection: 'column', gap: '1rem', alignItems:'center' }}>
      <Modal ref={modalRef} />
      <Modal ref={modalRef2} />
        ...
        <Row className="h-100">
          <Col className="h-100">
            ...
            <Table bordered hover style={{ width: '100%' }} className="m-0">
              <tbody>
                <tr>
                  <th width="30%" className=" bg-light text-end align-middle">공정</th>
      ...
      <div className="bg-light w-100">
        <Row className="h-100">
          <Col className="h-100 d-flex flex-column gap-2">
            <div className="d-flex gap-2">
              <span className="pt-2 fw-bold ">작업지시 정보</span>
            </div>
            ...
            <Table bordered hover style={{ width: '100%' }} className="m-0">
              <tbody>
                ...
                <tr>
                  <th width="30%" className=" bg-light text-end align-middle">주문번호</th>
                  <td width="auto" className="align-middle">
                    <div className="d-flex gap-2">
                      <Form.Control 
                        type="text"
                ...
                <tr>
                  <th className=" bg-light text-end align-middle">작업지시번호</th>
                ...
                <tr>
                  <th className=" bg-light text-end align-middle">시작</th>
                  <td className="align-middle">
                    <div className="d-flex gap-2">
                      <Form.Control 
                        type="text"
                        name="start_date"
                        value={modalForm.start_date + ' ' + modalForm.start_time ?? ""}
                        onChange={modalFormChange}
                        size="sm" 
                        className="w-100"
                        maxLength={50}
                ...
                <tr>
                  <th className=" bg-light text-end align-middle">종료</th>
                  <td className="align-middle">
                    <div className="d-flex gap-2">
                      <Form.Control 
                        type="text"
                        name="end_date"
                        value={modalForm.end_date + ' ' + modalForm.end_time ?? ""}
                        onChange={modalFormChange}
                        size="sm" 
                        className="w-100"
                        maxLength={50}
