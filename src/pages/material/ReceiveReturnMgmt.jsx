...
import PurchaseReceiveComponent from "./PurchaseReceiveMgmt";
...
const Main = () => {
  ...
  useEffect(()=>{
    ...
    .then((res) => {
      ...
      // 그리드 설정
      setColumnDefs([
        { headerName: "입고번호", field: "reference_receipt_id", sortable: true, editable: false, filter: "agTextColumnFilter",  align:"center"},
        { headerName: "반품번호", field: "return_id", sortable: true, editable: false, filter: "agTextColumnFilter",  align:"center"},
        { headerName: "반품일자", field: "return_date", sortable: true, editable: false, filter: "agDateColumnFilter",  align:"center"},
      ...
      // 그리드 설정2
      setColumnDefs2([
        { headerName: "반품번호", field: "return_id", sortable: false, editable: false, align:"center"},
        ...
        { headerName: "반품수량", field: "return_qty", sortable: false, 
          align:"right", 
          editable: false , 
          cellRendererSelector: (params) => {
            if (params.node.rowPinned) {
    ...
    modalRef.current.open({
      ...
      onConfirm: (res) => {
        ...
        if(!formRef.current.request_date){
          modalRef2.current.open({ title:"알림", message:"반품일을 입력하세요.", cancelText:"" });
          return;
        }
        ...
        axiosInstance
          .post(`/api/addReceiptReturn`, JSON.stringify(formRef.current))
          .then((res) => {
            getData();
            modalRef.current.close();
          })
    ...
    <div style={MainContentStyle}>
        ...
        <Row className="">
          <Col className="">
            <Table bordered hover style={{ width: 'auto', tableLayout: 'auto' }} className="m-0">
              <tbody>
                <tr>
                  <th className="bg-light text-end align-middle">반품 일자</th>
                  <td className="">
                  ...
                  <th className="bg-light text-end align-middle">반품 상태</th>
                  <td className="">
            ...
            <Table bordered hover style={{ width: 'auto', tableLayout: 'auto' }} className="m-0">
              <tbody>
                <tr>
                  <th className="bg-light text-end align-middle">반품 번호</th>
                  <td className="">
                      <Form.Control 
                        type="text"
                        name="return_id"
      ...
      <div className="h-100">
        <Row  className="h-100">
          <Col className="h-100 d-flex flex-column" xs={12} md={12}>
            <div className="mb-1 d-flex gap-2 justify-content-start align-items-center">
              <span className="fw-bold">반품  상세</span>
...
const ModalComponent = ({ form }) => {
  ...
  useEffect(()=>{
    ...
    .then((res) => {
      ...
      setColumnDefs([
        ...
        { headerName: "기준단위", field: "base_unit", sortable: false, editable: false, align:"center"},
        { headerName: "구매단위", field: "purchase_unit", sortable: false, editable: false, align:"center"},
        { headerName: "반품수량", field: "quantity", sortable: false, editable: true, align:"right", cellDataType: 'number',
          valueFormatter: (params) => moneyFormatter(params)
        },
  ...
  const getData4 = (params) => {
    ...
    modalRef.current.open({
      title: "입고 조회",
      content: <PurchaseReceiveComponent props={formRef4} />,
      onCancel: ()=>{
        modalRef.current.close();
      },
      confirmText:"확인",
            ...
            <Table bordered style={{ width: 'auto', tableLayout: 'auto' }} className="m-0">
              <tbody>
                ...
                <tr>
                  ...
                  <th className="bg-light text-end align-middle">반품일</th>
                  <td className="">
                    <div className="d-flex gap-2">
                      <Form.Control 
                        type="date"
