  ...
  useEffect(()=>{
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        // 그리드 설정
        setColumnDefs([
          { headerName: "출고일시", field: "receipt_date", sortable: true, editable: false, filter: "agDateColumnFilter",  align:"center", width:120},
          { headerName: "출고번호", field: "receipt_id", sortable: false, editable: false, align:"center", width:120},
  ...
  const exportExcel = () =>{
    ...
    if (gridRef.current) {
      gridRef.current.exportDataAsCsv({
        fileName: `export_${dayjs().format('YYYYMMDD')}_동일프라텍__출고이력.csv`
      });
    }
  };
        ...
        <Row  className="h-100">
          <Col className="h-100 d-flex flex-column" xs={12} md={12}>
            <div className="mb-1 d-flex gap-2 justify-content-start align-items-center">
              <span className="fw-bold">출고 이력</span>  
